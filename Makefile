...
.PHONY: all build test compose-up compose-down \
debezium-compose-up debezium-compose-down \
load-test-data vendor install-linter lint fmt tools tools-update generate \
activate-python-venv install-admin-deps run-django-admin \
